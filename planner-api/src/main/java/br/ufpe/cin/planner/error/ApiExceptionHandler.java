package br.ufpe.cin.planner.error;

import static java.util.stream.Collectors.toList;

import br.ufpe.cin.planner.error.ErrorResponse.ApiError;
import br.ufpe.cin.planner.service.exception.BusinessException;
