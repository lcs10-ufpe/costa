package br.ufpe.cin.analyzecloudcost.error;

import static java.util.stream.Collectors.toList;

import br.ufpe.cin.analyzecloudcost.error.ErrorResponse.ApiError;
import br.ufpe.cin.analyzecloudcost.service.exception.BusinessException;
