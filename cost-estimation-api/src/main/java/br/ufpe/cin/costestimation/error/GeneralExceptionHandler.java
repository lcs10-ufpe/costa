package br.ufpe.cin.costestimation.error;
...
public class GeneralExceptionHandler {
    ...
    public GeneralExceptionHandler(final ApiExceptionHandler apiExceptionHandler) {
        this.apiExceptionHandler = apiExceptionHandler;
    }

    @ExceptionHandler(Exception.class)
    public ResponseEntity<ErrorResponse> handlerInternalServerError(final Exception exception, final Locale locale) {
